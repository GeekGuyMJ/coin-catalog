...
function showAbout() {
 ...
 { heading: 'Themes & Customization', list: [
  '12 built-in themes: Dark, Light, Midnight, Gold, Copper, Ocean, Deep Forest, Silver, Aged Paper, Matrix, Cyberpunk, Neon',
 ...
 { heading: 'Data Management', list: [
  ...
  '   Option A — Factory Reset: wipe all data AND uploaded images, restoring the default images that shipped with the app',
  '   Option B — Clear Data, Keep Images: delete all data but keep every image you have uploaded and been using',
