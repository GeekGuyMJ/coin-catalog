    ...
    function buildAdvancedTab(panel) {
        panel.appendChild(el('div', { className: 'settings-section' }, [
            ...
            buildActionRow([
                ...
                { label: 'Coin Image Bank', onclick: () => import('./images.js').then(m => m.openCoinBankModal()), className: 'btn-secondary' },
...
export function openImageManager() {
    // Delegate to the unified coin bank in images.js
    import('./images.js').then(m => m.openCoinBankModal());
}
